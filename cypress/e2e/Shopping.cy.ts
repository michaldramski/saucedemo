...
describe('Shopping tests', () => {
    ...
    it('Should add product (Sauce Labs Backpack) into basket and check if item is in basket', () => {
        // Arrange
    ...
    it('Should add random product into basket and check count of items in basket', () => {
        // Arrange
    ...
    describe('Test Cases of Checkout', () => {
        ...
        it('Should verify error messages for credentials in checkout ', () => {
            // Arrange
            const checkoutUrl =
        ...
        it('Should be able to complete order', () => {
            // Arrange
            checkoutInformation = new CheckoutInformation();
            const checkoutOverview: CheckoutOverview = new CheckoutOverview();
            const checkoutComplete: CheckoutComplete = new CheckoutComplete();
            // Act
            checkoutInformation.navigateToOverview();
            ...
            checkoutComplete
                ...
                .should(
                    'equal',
                    messages.checkout.orderComplete.orderCompletedHeaderMessage,
                );
            checkoutComplete
                .getOrderCompleteText()
                .should(
                    'equal',
                    messages.checkout.orderComplete.orderCompletedTextMessage,
                );
        });
    });
});
